#!/usr/bin/env python3
"""
_doc_lookup.py -- runtime official-doc verification for alibabacloud-oss-static-website-diagnosis
=======================================================================
...
SKILL_TOPICS = [
    {"keywords": ["静态网站", "静态托管", "网站托管", "建站"], "hint": "static website hosting"},
    {"keywords": ["首页", "index.html", "默认首页", "404页面"], "hint": "index/error pages"},
    {"keywords": ["网页", "网站", "域名"], "hint": "website domain"},
    {"keywords": ["下载", "跳转"], "hint": "download instead of render"},
]
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Official-doc lookup self-test for alibabacloud-oss-static-website-diagnosis")
