...
def main() -> None:
    ...
    summary = (
        ...
        f"(identity type: {identity_type}). OSS static website hosting "
    ...
    suggestions = [
        ...
        "before running the static website diagnosis script.",
        "Proceed to static_website_diagnosis.py with --bucket (and "
        "optionally --endpoint / --region).",
    ]
    ...
    if args.json:
        ...
        # of the sibling OSS skills (their sts_token.py prints the
        # contract lines to stdout after the JSON document).
        print("\nSTATUS: OK")
        print("NEXT_ACTION: run static_website_diagnosis.py with --bucket "
              "(and optionally --endpoint / --region) to diagnose the "
        ...
        print("Next step       : if this is the account you expect, proceed "
              "with static_website_diagnosis.py. If not, switch to the "
