#!/usr/bin/env python3
"""
_doc_lookup.py -- runtime official-doc verification for alibabacloud-oss-lifecycle-runtime-diagnosis
=======================================================================
...
SKILL_TOPICS = [
    {"keywords": ["生命周期", "lifecycle"], "hint": "lifecycle rules"},
    {"keywords": ["归档", "冷归档", "深度冷归档", "解冻", "恢复"], "hint": "archive restore"},
    {"keywords": ["低频", "存储类型", "存储类别", "转归档", "转换"], "hint": "storage class transition"},
    {"keywords": ["过期", "自动删除", "删除策略"], "hint": "expiration"},
]
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Official-doc lookup self-test for alibabacloud-oss-lifecycle-runtime-diagnosis")
