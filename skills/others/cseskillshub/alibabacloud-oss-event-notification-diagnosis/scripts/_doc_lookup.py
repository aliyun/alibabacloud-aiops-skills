#!/usr/bin/env python3
"""
_doc_lookup.py -- runtime official-doc verification for alibabacloud-oss-event-notification-diagnosis
=======================================================================
...
SKILL_TOPICS = [
    {"keywords": ["事件通知", "事件", "通知规则"], "hint": "event notification"},
    {"keywords": ["回调", "callback"], "hint": "upload callback"},
    {"keywords": ["mns", "消息队列", "函数计算"], "hint": "event sink"},
    {"keywords": ["签名", "直传"], "hint": "server-side signature"},
]
...
_CONSULT_SIGNALS = (
    ...
    "多少", "费用", "收费", "价格", "？", "?",
    # Event-notification-domain request forms (callback / notification
    # trouble reports are usage consultations even without generic signals).
    "回调", "通知", "事件", "触发",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Official-doc lookup self-test for alibabacloud-oss-event-notification-diagnosis")
