...
# Scenario-specific topic table for the multipart-upload diagnosis skill
...
SKILL_TOPICS = [
    {"keywords": ["分片上传", "分片", "切片", "multipart", "partnumber", "uploadpart", "initiatemultipartupload"],
     "hint": "multipart-upload"},
    {"keywords": ["断点续传", "续传", "断点", "恢复上传", "重新上传", "resumable", "checkpoint"],
     "hint": "resumable-upload"},
    {"keywords": ["上传失败", "上传慢", "上传超时", "上传报错", "上传卡", "上传中断", "大文件", "上传", "upload", "timeout"],
     "hint": "upload-failure"},
    {"keywords": ["completemultipartupload", "合并", "碎片", "碎片清理", "listparts", "abortmultipartupload", "part"],
     "hint": "part-management"},
]
