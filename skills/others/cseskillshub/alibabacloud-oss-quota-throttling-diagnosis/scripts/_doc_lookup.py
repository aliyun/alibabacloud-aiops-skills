#!/usr/bin/env python3
"""
_doc_lookup.py -- runtime official-doc verification for alibabacloud-oss-quota-throttling-diagnosis
=======================================================================
...
SKILL_TOPICS = [
    {"keywords": ["限流", "流控", "限速", "节流", "慢"], "hint": "throttling"},
    {"keywords": ["qps", "配额", "quota", "带宽"], "hint": "quota"},
    {"keywords": ["503", "slown", "超时"], "hint": "SlowDown"},
    {"keywords": ["提升", "申请", "提到"], "hint": "quota increase"},
]
...
_CONSULT_SIGNALS = (
    ...
    "多少", "费用", "收费", "价格", "？", "?",
    # Quota-domain request forms (throttling reports / limit-raise requests
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Official-doc lookup self-test for alibabacloud-oss-quota-throttling-diagnosis")
