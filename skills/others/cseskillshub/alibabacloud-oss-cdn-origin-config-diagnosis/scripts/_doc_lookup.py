#!/usr/bin/env python3
"""
_doc_lookup.py -- runtime official-doc verification for alibabacloud-oss-cdn-origin-config-diagnosis
=======================================================================
...
SKILL_TOPICS = [
    {"keywords": ["cdn"], "hint": "CDN"},
    {"keywords": ["回源", "源站", "回源host", "回源流量"], "hint": "origin"},
    {"keywords": ["加速域名", "cname", "域名"], "hint": "accelerated domain"},
    {"keywords": ["私有桶", "私有", "授权"], "hint": "private bucket origin"},
    {"keywords": ["外网流量", "公网流量", "绕过"], "hint": "bypass CDN"},
]
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Official-doc lookup self-test for alibabacloud-oss-cdn-origin-config-diagnosis")
