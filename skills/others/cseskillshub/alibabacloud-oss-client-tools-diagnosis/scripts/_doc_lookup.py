#!/usr/bin/env python3
"""
_doc_lookup.py -- runtime official-doc verification for alibabacloud-oss-client-tools-diagnosis
=======================================================================
...
SKILL_TOPICS = [
    {"keywords": ["ossutil", "命令行工具", "命令行"], "hint": "ossutil"},
    {"keywords": ["ossbrowser", "图形化工具"], "hint": "ossbrowser"},
    {"keywords": ["sdk", "SDK"], "hint": "SDK"},
    {"keywords": ["sync", "cp", "上传", "下载", "同步", "打包"], "hint": "transfer commands"},
    {"keywords": ["exclude", "参数", "报错", "错误"], "hint": "usage errors"},
]
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Official-doc lookup self-test for alibabacloud-oss-client-tools-diagnosis")
