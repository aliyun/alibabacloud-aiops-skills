#!/usr/bin/env python3
"""
_doc_lookup.py -- runtime official-doc verification for alibabacloud-oss-browser-upload-cors-diagnosis
=======================================================================
...
SKILL_TOPICS = [
    {"keywords": ["跨域", "cors"], "hint": "CORS"},
    {"keywords": ["access-control", "allow-origin", "options", "预检", "preflight"], "hint": "CORS headers"},
    {"keywords": ["浏览器", "前端", "小程序", "直传", "上传"], "hint": "browser upload"},
    {"keywords": ["域名", "通配符", "来源"], "hint": "allowed origins"},
]
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Official-doc lookup self-test for alibabacloud-oss-browser-upload-cors-diagnosis")
