...
Usage:
 python yunxiao_flow_get_job_step_log.py --org-id <Organization ID> --pipeline-id <Pipeline ID> --pipeline-runid <Run ID> --job-id <Job ID> --step-index <Step Index> --token <Access Token> [--domain <Domain>] [--offset <Start Position>] [--limit <Log Length>] [--build-id <Build ID>]
...
Examples:
  ...
  python yunxiao_flow_get_job_step_log.py --org-id 64c1c73fa4a9f6530c595e17 --pipeline-id 3734309 --pipeline-runid 109 --job-id 1 --step-index 1 --token pt-xxx --domain openapi-rdc.aliyuncs.com

  # Query complete log (auto-paginated)
  python yunxiao_flow_get_job_step_log.py --org-id xxx --pipeline-id xxx --pipeline-runid xxx --job-id xxx --step-index 1 --token pt-xxx --full-log

  # Region edition
  python yunxiao_flow_get_job_step_log.py --org-id xxx --pipeline-id xxx --pipeline-runid xxx --job-id xxx --step-index 1 --token pt-xxx --domain region-org.devops.aliyuncs.com
        """
    )
