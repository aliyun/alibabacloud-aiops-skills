...
Usage:
 python yunxiao_flow_get_vm_deploy_order.py --org-id <Organization ID> --pipeline-id <Pipeline ID> --deploy-order-id <Deploy Order ID> --token <Access Token> [--domain <Domain>]
...
Examples:
  ...
  python yunxiao_flow_get_vm_deploy_order.py --org-id 5ebbc0228123212b59xxxxx --pipeline-id 123 --deploy-order-id 1111 --token pt-xxx --domain openapi-rdc.aliyuncs.com

  # Region edition: query deploy order details (org-id not required)
  python yunxiao_flow_get_vm_deploy_order.py --pipeline-id 123 --deploy-order-id 1111 --token pt-xxx --domain region-org.devops.aliyuncs.com
