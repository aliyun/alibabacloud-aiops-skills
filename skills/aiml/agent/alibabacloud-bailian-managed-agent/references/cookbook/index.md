...
> Source of these recipes: **end-to-end REST / curl field tests** on the Bailian cn-beijing region (2026-09). **Recipes 01-11 are documented**. Recipes 09-11 add scoped 2026-09-18 live checks; browser MCP and current Webhook delivery remain prerequisite-dependent.
...
| "Next session should pick up my project notes" / "research online without a search MCP" | [09-working-memory-and-web-research.md](09-working-memory-and-web-research.md) | Project handoff | MA Memory Store / built-in web tools / cross-session readback | Advanced |
| "Read an image and stream text incrementally" / "show Thinking status" | [10-multimodal-delta-and-thinking.md](10-multimodal-delta-and-thinking.md) | Visual assistant UI | Image file_id / event_start / event_delta / reasoning | Advanced |
| "Add data during a session and retrieve the approved result" | [11-live-resources-and-reviewed-deliverables.md](11-live-resources-and-reviewed-deliverables.md) | Order-analysis deliverable | Dynamic files / artifact download / main-Agent approval / MultiAgent and manual deployment checks | Advanced |
...
| MA working memory / cross-session handoff | [Memory distinction](../product/status.md) | 09 |
| Built-in web search / page reading | [Current tool rules](../product/concepts.md#tool-and-mcp) | 09; browser interaction still uses MCP |
| Multimodal images / Delta / Thinking | [Event contracts](../integration/api-quickstart.md) | 10; use the tested file_id image path |
| Runtime file add/remove | [File tutorial](../tutorials/03-mount-files.md) | 11; Memory Store cannot be dynamically mounted |
