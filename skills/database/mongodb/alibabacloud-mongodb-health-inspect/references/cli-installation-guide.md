...
```bash
aliyun ecs describe-instances --user-agent AlibabaCloud-Agent-Skills/alibabacloud-mongodb-health-inspect --profile projectA

export ALIBABA_CLOUD_PROFILE=projectA
aliyun ecs describe-instances --user-agent AlibabaCloud-Agent-Skills/alibabacloud-mongodb-health-inspect   # Uses projectA
```
...
aliyun ecs describe-regions --user-agent AlibabaCloud-Agent-Skills/alibabacloud-mongodb-health-inspect
...
aliyun ecs describe-regions --user-agent AlibabaCloud-Agent-Skills/alibabacloud-mongodb-health-inspect --log-level=debug
